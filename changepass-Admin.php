...
<form action="savepass-Admin.php" method="post" class="form-horizontal" enctype="multipart/form-data" >
<br>
        ...
        <div class="form-group">
            <div class="form-group">
              <div class="form-row">
                <label class="control-label col-sm-5" for="passwd">รหัสผ่าน : </label>
                <div class="col-sm-5">
